...
if data_choice == "flights.csv":
    data = pd.read_csv(r"C:\Users\KazKami\Documents\BDD exo Seaborn\flights.csv")
    st.dataframe(data)
    liste_col_x = data.columns.tolist()
    liste_col_y = data.columns.tolist()
if data_choice == "anscombe.csv":
    data = pd.read_csv(r"C:\Users\KazKami\Documents\BDD exo Seaborn\anscombe.csv")
    st.dataframe(data)
    liste_col_x = data.columns.tolist()
    liste_col_y = data.columns.tolist()
if data_choice == "attention.csv":
    data = pd.read_csv(r"C:\Users\KazKami\Documents\BDD exo Seaborn\attention.csv")
    st.dataframe(data)
    liste_col_x = data.columns.tolist()
    liste_col_y = data.columns.tolist()
if data_choice == "diamonds.csv":
    data = pd.read_csv(r"C:\Users\KazKami\Documents\BDD exo Seaborn\diamonds.csv")
    st.dataframe(data)
    liste_col_x = data.columns.tolist()
    liste_col_y = data.columns.tolist() 
if data_choice == "car_crashes.csv":
    data = pd.read_csv(r"C:\Users\KazKami\Documents\BDD exo Seaborn\car_crashes.csv")
    st.dataframe(data)
    liste_col_x = data.columns.tolist()
    liste_col_y = data.columns.tolist() 
